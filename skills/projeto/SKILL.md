---
name: projeto
description: Slash command pra trocar projeto ativo mid-session sem mudar CWD. Lista projetos da workspace atual. Atualiza cache de projeto ativo. Uso /projeto, /projeto <slug>, /projeto listar.
model: sonnet
