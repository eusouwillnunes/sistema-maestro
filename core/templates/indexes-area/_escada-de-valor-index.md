...
FROM ""
WHERE file.folder = this.file.folder AND tipo = "escada-de-valor" AND status = "concluido"
...
FROM ""
WHERE file.folder = this.file.folder AND tipo = "escada-de-valor" AND status = "cancelado"
